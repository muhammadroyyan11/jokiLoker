                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="settings">
                        <form class="form-horizontal">
                            <center><img class="profile-user-img img-responsive" src="<?= base_url() ?>assets/uploads/foto/<?= $satu->foto ?>" alt="User profile picture"></center><br>
        ...
        <div class="col-md-6">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="settings">
                        <form class="form-horizontal">
                        <center><img class="profile-user-img img-responsive" src="<?= base_url() ?>assets/uploads/foto/<?= $dua->foto ?>" alt="User profile picture"></center><br>
                            <div class="form-group">
                                <label for="inputName" class="col-sm-2 control-label">Lowongan</label>
