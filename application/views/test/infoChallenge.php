        ...
        <div class="row">
            <div class="col-sm-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Quiz dibuka sampai</th>
                        <td>
                            <?= strftime('%d %B %Y', strtotime($ujian->tgl_selesai)) ?>
            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        ...
                        <?php
                        $mulai = strtotime($ujian->tgl_dibuat);
                        $terlambat = strtotime($ujian->tgl_selesai);
                        $now = time();
                        if ($mulai > $now) :
                        ?>
                        ...
                        <?php else : ?>
                            <div class="callout callout-danger">
                                ...
                                Silahkan hubungi HRD untuk bisa mengikuti ujian pengganti.
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
